...
YCPSWASYN::YCPSWASYN(const char *portName, Path p, const char *recordPrefix, int recordNameLenMax, int autogenerate, const char* mapFilePath, const char* dictionary)
    : asynPortDriver(
        portName,
        MAX_SIGNALS,
        NUM_PARAMS,
...
int YCPSWASYN::autogenerateDatabase()
{
    ...
    try
    {
        ...
        fprintf( regDumpYamlFile.f(), "recordPrefix: %s\nroot:\n", recordPrefix_.c_str() );
...
// + YCPSWASYNConfig //
extern "C" int YCPSWASYNConfig(const char *portName, const char *yaml_doc, const char *rootPath, const char *ipAddr, const char *recordPrefix, unsigned int recordNameLenMax, int autogeneration, const char* mapFilePath, const char* dictionary)
{
    int status;
    Path p;
    ...
    new YCPSWASYN(portName, p, recordPrefix, recordNameLenMax, autogeneration, mapFilePath, dictionary);
